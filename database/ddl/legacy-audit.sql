...
SELECT
	...
	"aud#user",
	"aud#seq"
FROM jazzhands_audit.account_auth_log;
...
SELECT "appaal_instance_id","app_key","appaal_group_name","appaal_group_rank","app_value","encryption_key_id","data_ins_user","data_ins_date","data_upd_user","data_upd_date","aud#action","aud#timestamp","aud#realtime","aud#txid","aud#user","aud#seq"
...
SELECT
	...
	"aud#user",
	"aud#seq"
FROM jazzhands_audit.person_auth_question;
...
SELECT "appaal_group_name","app_key","description","data_ins_user","data_ins_date","data_upd_user","data_upd_date","aud#action","aud#timestamp","aud#realtime","aud#txid","aud#user","aud#seq"
FROM jazzhands_audit.val_app_key;



CREATE OR REPLACE VIEW audit.val_app_key_values AS
SELECT "appaal_group_name","app_key","app_value","data_ins_user","data_ins_date","data_upd_user","data_upd_date","aud#action","aud#timestamp","aud#realtime","aud#txid","aud#user","aud#seq"
FROM jazzhands_audit.val_app_key_values;
...
SELECT "auth_question_id","question_text","data_ins_user","data_ins_date","data_upd_user","data_upd_date","aud#action","aud#timestamp","aud#realtime","aud#txid","aud#user","aud#seq"
FROM jazzhands_audit.val_auth_question;



CREATE OR REPLACE VIEW audit.val_auth_resource AS
SELECT "auth_resource","description","data_ins_user","data_ins_date","data_upd_user","data_upd_date","aud#action","aud#timestamp","aud#realtime","aud#txid","aud#user","aud#seq"
FROM jazzhands_audit.val_auth_resource;
...
SELECT
	...
	"aud#user",
	"aud#seq"
FROM jazzhands_audit.volume_group_physicalish_vol;
